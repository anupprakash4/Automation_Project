...
#check whether Apache is installed or not
...
#check whether AWSCLI installed or not 
...
# Task 4 - Check cron file exists or not , if it doesn't exist and then create it 
#NOTE :- Script will execute once in day at 4:05 AM 
